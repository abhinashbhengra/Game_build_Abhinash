window.addEventListener("load", function () {
  ...
  class Background {
    constructor(game) {
      ...
      this.image1 = document.getElementById("Frame4");
      this.image2 = document.getElementById("city");
      this.image3 = document.getElementById("base");
      this.image4 = document.getElementById("broken");
  ...
  class UI {
    ...
    draw(context) {
      ...
      //ammo bar
      if (this.game.player.powerUp) context.fillStyle = "#ffffdb";
  ...
  class Game {
    ...
    addEnemy() {
      ...
      else if (randomizer < 0.8) this.enemies.push(new HiveWhale(this));
